...
const SEQS: Seq[] = [
  {
    // 제프 워커식 사전 론칭 + 브런슨 '3가지 착각(false belief)' 프레임.
    // 신청 ~ 강의(라이브) 사이의 죽은 구간을 교육 콘텐츠로 채운다.
    key: "pre_launch",
    name: "사전 교육 시퀀스 (3가지 착각 깨기)",
    trigger: "signup",
    ...
    steps: [
      {
        delayMinutes: 3 * H,
        audience: "all",
        body: "{이름}님, 신청 감사해요. 강의 보시기 전에 딱 하나만 짚을게요.\n\n대부분 \"시간·돈·경험이 없어서 나는 안 될 것\"이라고 생각해요. 그런데 실제로 된 분들은 그 셋 다 없이 시작했습니다. 있어야 했던 건 '순서' 하나였어요.\n\n그 순서를 강의에서 처음부터 보여드릴게요.\n📎 {링크}",
      },
      {
        delayMinutes: 1 * D,
        audience: "all",
        body: "{이름}님, 어제 강의는 보셨어요?\n\n\"남들은 되는데 나는 재능이 없어서\"라고 생각하셨다면, 3년 전 제가 딱 그랬습니다. 지금 잘 되는 분들도 시작할 땐 똑같이 말했고요.\n\n재능이 아니라 '계속 굴러가는 구조'가 만든 결과예요. 아직 안 보셨으면 오늘 꼭 챙겨보세요.\n📎 {링크}",
      },
      {
        delayMinutes: 2 * D,
        audience: "all",
        body: "{이름}님, 마지막 착각 하나요.\n\n\"블로그도 유튜브도 해봤는데 나한텐 안 맞더라\" — 방법이 틀린 게 아니라 '팔리는 제안'을 안 배운 채로 한 거예요. 제안하는 법만 바꿔도 같은 콘텐츠가 매출이 됩니다.\n\n이걸 {상품명}에 전부 정리해뒀어요. 강의랑 같이 보면 제일 빠릅니다.\n👉 {결제링크}",
      },
      {
        delayMinutes: 3 * D,
        audience: "not_purchased",
        body: "{이름}님, 무료 시청이 곧 닫히고 {상품명} 특가 링크도 영상이랑 같이 사라져요.\n\n'제안하는 법' 하나 때문에 여기까지 돌아오셨다면, 지금이 그걸 끝낼 타이밍이에요.\n👉 {결제링크}",
      },
    ],
  },
  {
    // 브런슨식 팔로우업 퍼널: 리플레이(다시보기) 창이 닫힐 때까지
    // 망설임(돈·시간·실행 자신)을 하나씩 반박하고 마지막에 마감으로 민다.
    // {마감시각} = 라이브 퍼널이면 회차 리플레이 마감, 그 외엔 무료시청 만료.
    key: "replay_close",
    name: "리플레이 마감 시퀀스 (반론 격파 + 마감)",
    trigger: "watch_start",
    stopOn: ["purchase"],
    steps: [
      {
        delayMinutes: 90,
        audience: "not_purchased",
        body: "{이름}님, 강의 보고 계시죠? 끝까지 못 보셨으면 {마감시각} 마감 전에 꼭 다시 보세요.\n📎 {링크}\n\n보시다 막히는 부분은 {상품명}에 정리돼 있어요.\n👉 {결제링크}",
      },
      {
        delayMinutes: 20 * H,
        audience: "not_purchased",
        body: "{이름}님, \"지금 돈 쓸 때인가\" 싶으시죠. 저도 그 고민 했어요.\n\n근데 {상품명} 없이 혼자 시행착오하는 시간이 훨씬 비쌉니다. 한 번 세팅하면 계속 굴러가는 구조라서요.\n👉 {결제링크}",
      },
      {
        delayMinutes: 32 * H,
        audience: "not_purchased",
        body: "{이름}님, \"어차피 시간이 없어서 못 할 것 같다\" — 제일 많이 듣는 말이에요.\n\n그래서 {상품명}은 하루 30분이면 되게 순서대로 짜놨어요. 몰아서 안 해도 됩니다.\n👉 {결제링크}",
      },
      {
        delayMinutes: 44 * H,
        audience: "not_purchased",
        body: "{이름}님, \"사놓고 안 하면 어쩌지\" 싶으면, 그건 자료가 아니라 '순서'가 없어서예요.\n\n{상품명}은 1번부터 따라만 하면 되게 돼 있고, 막히면 이 번호로 답장 주시면 돼요.\n👉 {결제링크}",
      },
      {
        delayMinutes: 47 * H,
        audience: "not_purchased",
        body: "{이름}님, 진짜 마지막이에요. 잠시 뒤 {마감시각}에 영상이랑 {상품명} 링크가 같이 사라집니다.\n\n나중에 다시 열어달라고 하셔도 안 돼요. 지금 결정하세요.\n👉 {결제링크}",
      },
    ],
  },
  {
