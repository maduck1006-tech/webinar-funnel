...
export const VAR_KEY: { name: string; desc: string; pending?: boolean }[] = [
  ...
  { name: "{단톡방링크}", desc: "캠페인 설정의 단톡방 초대 링크 (없으면 단톡방 안내 페이지)" },
  { name: "{세일즈링크}", desc: "전자책/강의/상담 세일즈 페이지 링크" },
  { name: "{강의실링크}", desc: "VOD 강의실 링크" },
  { name: "{라이브링크}", desc: "라이브 웨비나 신청 퍼널의 외부 라이브(유튜브 라이브 등) URL" },
  { name: "{라이브일시}", desc: "등록한 회차의 시작 일시" },
  { name: "{상품명}", desc: "연결된 저가 상품 이름" },
  { name: "{다운로드링크}", desc: "워크북 다운로드 링크. 캠페인 설정 URL 우선, 없으면 전자책 다운로드 페이지, 그마저 없으면 시청 링크" },
